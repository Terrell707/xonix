...
/**
 * Creates a sound the simulates a crowd cheering.
 * @author Adrian
 *
 */
public class LevelCompleteClip {
	 ...
	 */
	public LevelCompleteClip()
	{
		// Creates the directory in which the sound is located.
		String soundDir = "." + File.separator + "sounds" + File.separator + "levelComplete.wav";
