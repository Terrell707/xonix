...
/**
 * Creates a sound that simulates squares being brought into existence.
 * @author Adrian
 *
 */
public class CreateSquaresClip {
	 ...
	 */
	public CreateSquaresClip()
	{
		// Creates the directory in which the sound is located.
		String soundDir = "." + File.separator + "sounds" + File.separator + "createSquares.wav";
